...
Usage:
    uv run convert-jupyter.py notebook.ipynb
    uv run convert-jupyter.py notebook.ipynb -o output.md
    uv run convert-jupyter.py notebook.ipynb --code-only
    uv run convert-jupyter.py ./notebooks/ --batch
"""
...
try:
    ...
    print("    uv run convert-jupyter.py <notebook_or_dir>")
    print("Or, in a uv project: `uv add 'markitdown[all]'`.")
    sys.exit(1)
